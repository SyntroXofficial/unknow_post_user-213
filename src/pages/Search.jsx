...
function Search() {
  ...
  const getGenreBadge = (type) => {
    return type === 'movie' ? (
      <span className="px-2 py-1 bg-purple-500/10 text-purple-400 rounded-full text-xs font-semibold">
        <FaFilm className="inline-block mr-1" />
        Movie
      </span>
    ) : (
      <span className="px-2 py-1 bg-blue-500/10 text-blue-400 rounded-full text-xs font-semibold">
  ...
  return (
    <div className="min-h-screen bg-black pt-32 px-16 pb-16">
      <div className="max-w-7xl mx-auto">
        {/* Search Header */}
        <div className="bg-[#111]/80 backdrop-blur-sm rounded-2xl p-8 mb-8 border border-gray-800">
          <div className="flex items-center justify-between mb-6">
            ...
            <select
              ...
              className="bg-[#0a0a0a] text-white px-4 py-2 rounded-lg border border-gray-800 focus:outline-none focus:border-purple-500"
            >
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 space-y-4">
            <div className="bg-[#111]/80 backdrop-blur-sm rounded-full p-8 border border-gray-800">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
            {filteredResults.map((item) => (
              ...
              >
                <div className="relative rounded-xl overflow-hidden bg-[#111] shadow-2xl border border-gray-800/50">
                  <img
