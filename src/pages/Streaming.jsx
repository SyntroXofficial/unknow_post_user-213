      ...
      <div className="relative z-10 px-12 pt-8 pb-4">
        <form onSubmit={(e) => {
          ...
          <input
            ...
            className="w-full bg-[#111] border border-purple-500/50 text-white px-6 py-4 rounded-lg placeholder-gray-400 focus:outline-none focus:border-purple-500 text-lg"
          />
          <button 
            type="submit"
            className="absolute right-4 top-1/2 -translate-y-1/2 text-white hover:text-purple-500 transition p-2"
          >
